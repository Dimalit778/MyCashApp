...
app.use(
  cors({
    origin: [ORIGIN, 'http://localhost:3000', process.env.CLIENT_URL, process.env.RENDER_FRONTEND_URL].filter(Boolean), // Remove undefined values
    credentials: true,
...
app.use((req, res, next) => {
  ...
  res.header('Access-Control-Allow-Headers', 'Content-Type, Authorization, Cookie, Refresh');
